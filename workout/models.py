...
from workout import db, login_manager, app
...
class User(db.Model, UserMixin):
    ...
    # gets token for password resets
...
#Table for Users to follow other users
class Followers(db.Model):
    ...
    def __repr__(self):
        return f"Followers('{self.id}', '{self.user_id}', '{self.follower_id}')"

#Table for Posts in database
class Post(db.Model):
    id = db.Column(db.Integer, primary_key=True)
